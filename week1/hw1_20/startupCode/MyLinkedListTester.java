...
public class MyLinkedListTester {
	...
	public static void testContains() { //passed test
		...
		System.out.println(list2.contains("1:Good")); // should print true
		System.out.println(list2.contains("6:Tony")); // print true
		System.out.println(list2.contains("notexist")); // should print false
		System.out.println(list2.contains("")); // should print false
	...
	public static void main(String argv[]) {
		...
		testAddLast(); // done [graphed]
		testRemoveFirst(); // done [graphed]
		testContains(); // done [graphed]
		testRemoveObject();// done [graphed]
		testRemoveAllCopies();// done [graphed]
		testInterleave(); // done [graphed]
		testAddIndex(); // done [graphed]
		testRemoveIndex(); // done [graphed]
		testGetIndex(); // done [graphed]
	}//end of main
}
